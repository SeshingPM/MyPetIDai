-- Migration: 20250618040000_resolve_function_conflict.sql
-- Description: Resolves function overloading conflict by dropping old function and recreating with TEXT parameters

-- First, drop the existing functions with both signatures to avoid conflicts
...
-- Now create the single function with TEXT parameters for medications and supplements
