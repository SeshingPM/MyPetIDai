...
-- The function is using owner_id but our pets table uses user_id
...
BEGIN
  ...
  BEGIN
    ...
    -- Insert pet data - FIXED: Changed owner_id to user_id
    INSERT INTO pets (
      id,
      user_id, -- This was incorrectly referred to as owner_id in the Edge Function
      name,
      type,
      breed,
      gender,
    ...
    -- Note: The pet_id_generation trigger should automatically generate the pet_identifier
    ...
    -- FIXED: Add type checking to prevent "cannot get array length of a scalar" error
